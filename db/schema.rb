...
ActiveRecord::Schema[8.0].define(version: 2025_05_21_065444) do
  ...
  create_table "disbursements", force: :cascade do |t|
    ...
    t.bigint "monthly_fee_compliance_id", comment: "The fee compliance that the disbursement belongs to, can be null if the disbursement is not related to a fee compliance"
    t.index ["merchant_id", "disbursement_date"], name: "index_disbursements_on_merchant_id_and_disbursement_date", unique: true
    t.index ["monthly_fee_compliance_id"], name: "index_disbursements_on_monthly_fee_compliance_id"
  end
  ...
  add_foreign_key "disbursements", "monthly_fee_compliances"
