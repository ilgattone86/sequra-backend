...
ActiveRecord::Schema[8.0].define(version: 2025_05_22_154733) do
  ...
  create_table "annual_reports", force: :cascade do |t|
    ...
    t.float "amount_of_orders_commission_fee", default: 0.0, null: false, comment: "Total amount of orders fee in the period"
  ...
  create_table "disbursements", force: :cascade do |t|
    ...
    t.float "total_commission_fee", default: 0.0, null: false, comment: "The sum of the commission fees of all the orders"
  ...
  create_table "monthly_fee_compliances", force: :cascade do |t|
    ...
    t.float "total_commissions_fees_generated", default: 0.0, null: false, comment: "The total commissions generated by the merchant in the month"
